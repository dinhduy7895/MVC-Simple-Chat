...
<head>
  ...
  <!-- Bootstrap 3.3.6 -->
  <link rel="stylesheet" href="<?php  echo PATH; ?>plugins/bootstrap/css/bootstrap.min.css">
  <!-- Font Awesome -->
  ...
  <!-- Theme style -->
  <link rel="stylesheet" href="<?php  echo PATH; ?>plugins/dist/css/AdminLTE.min.css">
  <!-- AdminLTE Skins. Choose a skin from the css/skins
       folder instead of downloading all of them to reduce the load. -->
  <link rel="stylesheet" href="<?php  echo PATH; ?>plugins/dist/css/skins/_all-skins.min.css">
  <link rel="stylesheet" href="<?php  echo PATH; ?>plugins/multiselect/bootstrap-multiselect.css">
  <link rel="stylesheet" href="<?php  echo PATH; ?>plugins/myCss/style.css">
  ...
  <script src="<?php  echo PATH; ?>plugins/bootstrap/js/bootstrap.min.js"></script>
